...
import { IconHexagonLetterC, IconHexagonLetterN, IconX } from '@tabler/icons-react';
      ...
      <Drawer.Root className='md:hidden'  position='right' opened={opened}   onClose={close} size="50vw" >
        ...
        <Drawer.Content bg="#0A192F">
          <Drawer.Header bg="#0A192F">
            <Drawer.Title ><IconHexagonLetterN size={48} color="#64FFDA" stroke={1.25}/></Drawer.Title>
