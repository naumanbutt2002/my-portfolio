    ...
    return (
        <div className="flex overflow-hidden justify-around items-center font-mono px-16 h-[82vh]" id="bg">
            <div className="ml-20 w-3/5 flex flex-col">
                ...
                <Button component="a" href="https://www.github.com/naumanbutt2002" target="_blank" className="!text-bgColor !w-fit" size="lg" variant="filled" color="#64FFDA">Check Resume</Button>
            </div>
            <div className="h-[50vh] flex justify-center items-center overflow-hidden rounded-full mr-14 w-[25vw]" id="photo">
                <img className="w-[85%] rounded-full shadow-xl" src="/profile.jpg" alt="profile" />
            </div>
        </div>
    )
}
